        ...
        <div key={activity.date} className="space-y-2.5">
          ...
          <div className="space-y-2.5">
            <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3">
              ...
              <span className="text-zinc-100">{activity.activities[0].title}</span>
              <span className="text-zinc-400 text-sm ml-auto">{format(activity.activities[0].occurs_at, 'HH:mm')}h</span>
            </div>
          </div>
          ) : (
